...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('resources/user/') ?>image/bb1.jpg">
</head>
				...
				<div class="row  mb--60">
					<div class="col-lg-12 mb--30">
						<div class="row no-gutters">
							<div class="col-sm-12 mb--15 mb-sm--0 order-sm-2">
								<!-- Product Details Slider Big Image-->    <div class="blog-post post-details mb--50">
                                        <div class="blog-content mt--30">
                     
                        <footer class="blog-meta">
                            <div> <a href="">Replies</a></div>
                        </footer>
                    </div>
                </div>
                    ...
                    <div class="single-comment">
                        ...
                        <div class="comment-avatar">
                            <img src="<?php echo base_url("resources/shared/images/".$i->userimageurl)?>" alt="" height="50px" width="50px" />
                        </div>
                        <div class="comment-text">
                           
                            <h5 class="author"> <a href="#"> <?php echo $i->username?></a></h5>
                          
                           <p> <span class="time"><?php echo "Inquiry:".$i->message?></span></p>
                            <p><span class="time"><?php echo "Answer:".$i->reply?></span></p>
                        </div>
							...
							<div class="product-details-modal">
								<div class="row">
									<div class="col-lg-7 mt--30 mt-lg--30">
										<div class="product-details-info pl-lg--30 " >
											<form method="post" action="<?php echo site_url("Inquiry/Resendinquiry/$i->bookid/$i->fromuserid")?>">
												<div class="row">
