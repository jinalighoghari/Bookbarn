...
<!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 May 2020 06:15:52 GMT -->
<head>
	<meta charset="utf-8" />
		...
		<main class="inner-page-sec-padding-bottom">
			<div class="container">
						...
						<div class="product-card card-style-list">
							<div class="product-grid-content">
								<div class="product-header">
									<a href="<?php echo site_url('MyProfile/loadOtherUserBasic/'.$b->userid)?>" class="author">
										<?php echo $b->username?>
									</a>
                    ...
                    ?>
										...
										<div class="hover-contents">
											...
											<div class="hover-btns">
												<a href="<?php echo site_url('Explore/AddtoCart/'.$b->bookid)?>" class="single-btn">
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									...
									<div class="btn-block">
										...
										<a href="<?php echo site_url('Explore/AddtoCart/'.$b->bookid)?>" class="card-link"><i class="fas fa-shopping-basket"></i> Add To Cart</a>
              ...
              "asNavFor": ".product-slider-nav"
                      ...
                      // die();
                    ?>
												<img src="<?php echo base_url('resources/shared/images/'.$im[0])?>" alt="" height="400" width="10">
											</div>
									...
									<div class="col-lg-7 mt--30 mt-lg--30">
										<div class="product-details-info pl-lg--30 " >
											...
											<li>Author: <span class="list-value"><?php echo $b->authorname?></span></li>												<li>Category: <a href="#" class="list-value font-weight-bold"><?php echo $b->catname?></a></li>
                                ...
                                ?></span></li>
											...
											<div class="add-to-cart-row">
												...
												<div class="add-cart-btn">
													<a href="<?php echo site_url('Explore/AddtoCart/'.$b->bookid)?>" class="btn btn-outlined--primary"><span
