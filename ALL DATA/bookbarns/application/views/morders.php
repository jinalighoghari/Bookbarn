			...
			<div class="container">
				<div class="row">
					<div class="col-12">
                      ...
                      $im=explode(" ", $i);
                      ?>
										<td class="pro-thumbnail"><a href="<?php echo site_url("Explore/bookMoreInfo/".$b->bookid)?>"><img src="<?php echo base_url('resources/shared/images/'.$im[0])?>" alt=""></a></td>
										<td class="pro-title"><a href="<?php echo site_url("Explore/bookMoreInfo/".$b->bookid)?>"><?php echo $b->bookname?></a></td>
										<td class="pro-title"><a href="<?php echo site_url('MyProfile/loadOtherUserBasic/'.$b->suid)?>"><?php echo $b->uname?></a></td>
