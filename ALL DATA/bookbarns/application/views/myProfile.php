            ...
            <form action="<?php echo site_url('MyProfile/editbasic')?>" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                  ...
                  <div class="col-md-12 col-12 mb--15">
                    ...
                    <input class="mb-0 form-control" type="text" id="uname" name="txtuname" value="<?php echo $userinfo->username?>" >
                  </div>
                  
                  <div class="col-md-12 col-12 mb--15">
                    <label for="fname">FirstName</label>
                    <input class="mb-0 form-control" type="text" id="fname" name="txtfname" value="<?php echo $userinfo->firstname?>">
                  </div>

                  <div class="col-md-12 col-12 mb--15">
                    <label for="lname">LastName</label>
                    <input class="mb-0 form-control" type="text" id="lname" name="txtlname" value="<?php echo $userinfo->lastname?>">
                  </div>

                  <div class="col-12 mb--20">
                    <label for="email">Email</label>
                    <input class="mb-0 form-control" name="txtemail" type="email" id="email" value="<?php echo $userinfo->useremailid?>">
                  </div>

                  <div class="col-12 mb--20">
                    <label for="contact">Contact.No</label>
                    <input class="mb-0 form-control" name="txtcon" type="text" id="contact" value="<?php echo $userinfo->contactno?>">
                  </div>
