    ...
    <main class="page-section inner-page-sec-padding-bottom">
      <div class="container">
        <div class="row">
            ...
            <form action="<?php echo site_url('Changepass/editPass')?>" method="post" enctype="multipart/form-data">
              <div class="login-form">
                ...
                <div class="row">
                  <div class="col-md-12 col-12 mb--15">
                    ...
                    <input class="mb-0 form-control" required="" type="password" id="name" name="txtopwd"  
                      >
                  </div>
                  <div class="col-md-12 col-12 mb--15">
                    <label for="npassword">New Password</label>
                    <input class="mb-0 form-control" required="" type="password" id="name" name="txtnpwd" 
                      >
                  </div>
                  <div class="col-md-12 col-12 mb--15">
                    <label for="cpassword">Confirm Password</label>
                    <input class="mb-0 form-control" type="password" id="name" name="txtcpwd" 
                     >
                  </div>
