...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<span class="pull-right"><a href="<?php echo site_url("admin/Category/loadaddsubcat/".$catid)?>" class="btn btn-primary">Add Sub-Category</a></span>
			<!-- BEGIN breadcrumb -->
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						...
						<th style="white-space: nowrap">SubCategory Name</th>
					     
						<th style="white-space: nowrap">Tags</th>
						<th class="no-sort" style="width:1%">ACTIONS</th>
					</tr>
				</thead>
				...
				<tbody>
						...
						<tr>
						<td><?php echo $s->subcatid ?></td>	
						<td><?php echo $s->subcatname?></td>
						<td><a href="<?php echo site_url("admin/Category/loadalltagsbysubcatid/".$s->subcatid)?>">Tags</a></td>
						<td class="btn-col" style="white-space: nowrap">
							<a href="<?php echo site_url("admin/Category/loadeditsubcat/$s->subcatid/$s->catid")?>" class="btn btn-white btn-xs"><i class="ti-pencil"></i></a>
   							<a href="<?php echo site_url("admin/Category/removesubcat/$s->subcatid/$s->catid")?>" class="btn btn-white btn-xs"><i class="ti-close"></i></a>
						</td>
						</tr>
