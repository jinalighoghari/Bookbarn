...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
			...
			<div class="header-search-bar">
                <form action="#" method="POST" name="search_bar_form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="header-search" required="" placeholder="Search infinite admin..." />
		...
		<div id="content" class="content">
			<!-- BEGIN breadcrumb -->
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="#"><h2>Add Tag</h2></a></li>
			    ...
			    <div class="col-md-6 offset-3">
			    	...
			    	<div class="panel panel-default">
			    		...
			    		<div class="panel-heading">
			    			<h4 class="panel-title">Add Tag</h4>
			    		</div>
			        	<!-- END panel-heading -->
			        	<!-- BEGIN panel-body -->
			    		<div class="panel-body">
			    			<form method="post" action="<?php echo site_url('admin/Category/Addtag/'.$subcatid)?>">
								<div class="form-group">
									<label class="control-label">TagName<span class="text-danger">*</span></label>
									<input type="text" class="form-control" name="txttagname" value="" placeholder="Enter Tag Name" />
								</div>
