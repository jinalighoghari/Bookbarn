		...
		<div id="content" class="content">
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				...
				<tbody>
                    ...
                    ?>
                    <a href="<?php echo site_url("admin/BMoreInfo/index/".$b->bookid)?>"><img src="<?php echo base_url("resources/shared/images/$im[0]")?>"  height="75px" width="75px"></a></td>
