			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						...
						<th class="no-sort" style="width:1%">Wishlist</th>
					</tr>
				</thead>
				...
				<tbody>
				   ...
				   <!--  <td><?php echo $u->userid ?></td> -->
					<td><a href="<?php echo site_url("admin/User/usermoreinfo/".$u->userid)?>"><?php echo $u->username ?></a></td>
					<td><?php echo $u->firstname?></td>
    				<td><?php echo $u->lastname?></td>
       				<td><?php echo $u->useremailid?></td>
           			<td><?php echo $u->contactno?></td>
					<td><img src="<?php echo base_url("resources/shared/images/$u->userimageurl")?>" height="75px" width="75px">
					</td>

						
						<td class="btn-col" style="white-space: nowrap">
					 <a href="<?php echo site_url("admin/User/UWishlist/".$u->userid)?>"><i class="ti-heart"></i></a>
