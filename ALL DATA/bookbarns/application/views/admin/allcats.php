...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<span class="pull-right"><a href="<?php echo site_url('admin/Category/addcategory')?>" class="btn btn-primary">Add Category</a></span>
			<!-- BEGIN breadcrumb -->
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						...
						<th style="white-space: nowrap">Sub-categories</th>
				...
				<tbody>
					...
					<td><a href="<?php echo site_url('admin/Category/loadallsubcatbyid/'.$c->catid)?>">Sub-Categories</a></td>
					<td class="btn-col" style="white-space: nowrap">
						<a href="<?php echo site_url('admin/Category/loadeditview/'.$c->catid)?>" class="btn btn-white btn-xs"><i class="ti-pencil"></i></a>
						<a href="<?php echo site_url('admin/Category/removecat/'.$c->catid)?>" class="btn btn-white btn-xs"><i class="ti-close"></i></a>
					</td>
