...
<div><?php echo @date('d-m-Y')?>	</div>					</div>
						<div class="widget-stats-icon">
							<i class="ti-book text-inverse"></i>
						</div>
					</a>
					<!-- END widget -->
				</div>
...
<div><?php echo @date('d-m-Y')?>	</div>						</div>
				...
				<div class="col-md-6 col-12 mb--15"> 
					<!-- BEGIN widget -->
					<a href="<?php echo site_url('admin/Orders/')?>" class="widget widget-stats bg-gradient-orange-dark">
						<div class="widget-stats-info">
...
<div><?php echo @date('d-m-Y')?>	</div>						</div>
				...
				<div class="col-md-12 ">
				<div  class="widget widget-stats bg-gradient-blue-dark" id="profile-photos">
								...
								<ul class="img-grid-list">
									...
									{
										?>
										<!-- <a href="<?php echo site_url('admin/BMoreInfo/index/'.$ml->bookid)?>"></a> -->
										 <?php
                      $i=$ml->image;
                      $im=explode(" ", $i);
                      // print_r($im);
                      // die();
                    ?>
									<li><a href="<?php echo site_url("admin/BMoreInfo/index/".$ml->bookid)?>"><img src="<?php echo base_url("resources/shared/images/".$im[0])?>" class="" height="150px" width="150px"/><h5 style="color: white"><?php echo $ml->bookname?></h5></a></li>
