			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						...
						<!-- <th class="no-sort" style="width:1%">BookID</th> -->
...
<td> <?php
                    ...
                    ?>
						<img src="<?php echo base_url("resources/shared/images/$im[0]")?>" height="75px" width="75px">
					</td>
						<td><?php echo $b->authorname?></td>
					...
					<a href="<?php echo site_url("admin/BMoreInfo/index/".$b->bookid)?>"><i class="ti-info-alt"></i></a>
