...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content">
			<!-- BEGIN breadcrumb -->
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="#"><h2>Add Category</h2></a></li>
			    ...
			    <div class="col-md-6 offset-3">
			    	...
			    	<div class="panel panel-default">
			    		...
			    		<div class="panel-body">
			    			<form method="post" action="<?php echo site_url('admin/Category/showcat')?>">
								<div class="form-group">
									<label class="control-label">Categoryname <span class="text-danger">*</span></label>
									<input type="text" class="form-control" required="" name="txtcatname" value="" placeholder="Enter Category Name" />
								</div>
