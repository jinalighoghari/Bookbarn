...
<body>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content">
			<span class="pull-right"><a href="<?php echo site_url("admin/Category/loadaddtags/".$subcatid)?>" class="btn btn-primary">Add Tag</a></span>
			
			<!-- BEGIN page-header -->
			<h1 class="page-header">
				<!-- <?php echo $tags[0]->subcatname?> -->
			</h1>
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						...
						<!-- <th style="white-space: nowrap">SubCategory ID</th> -->
				...
				<tbody>
					...
					<td><?php echo $t->tagid ?></td>
					<td><?php echo $t->tagname?></td>
					<td class="btn-col" style="white-space: nowrap">   
						<a href="<?php echo site_url("admin/Category/loadedittag/$t->tagid/$t->subcatid")?>" class="btn btn-white btn-xs"><i class="ti-pencil"></i></a>
   						<a href="<?php echo site_url("admin/Category/removetag/$t->tagid/$t->subcatid")?>" class="btn btn-white btn-xs"><i class="ti-close"></i></a>
					</td>
